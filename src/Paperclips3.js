  ...
  render() {
    ...
    let leaderboard = prof_map.map((n, sorted_i) => {
      ...
      return (
        ...
        >
          ...
          >
            {sorted_i + 1}. {this.factory_names[fi]}
          </div>
          <div style={{}}>
            <div style={{}}>
            ...
            <div style={{}}>
              <div style={{}}>STRATEGY HISTORY:</div>
      ...
      strategy_info = (
        <div>
          ...
          <p style={{ overflow: 'hidden' }}>
            ...
            >
              <div style={{ fontSize: smaller_font }}>STRATEGY:</div>
    ...
    let to_render = (
      <div
        style={{
          display: 'grid',
          gridTemplateRows: '20px calc(100vh - 40px) 20px',
        }}
      >
        <div
          style={{
        ...
        >
          <div style={{ fontWeight: 700 }}>Turbofan Tycoon</div>
          <div />
          ...
          <div style={{ overflow: 'auto', position: 'relative' }}>
            ...
            >
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div className="v-border" style={{ left: -1 }} />
              </div>
            </div>
